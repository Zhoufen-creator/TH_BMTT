...
public class frm_FileHash extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btSaveHash = new javax.swing.JButton();
        btFileHash = new javax.swing.JButton();
        ...
        btSaveHash.setText("Save Hash");
        btSaveHash.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btSaveHashActionPerformed(evt);
            }
        });

        btFileHash.setText("File Hash");
        btFileHash.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btFileHashActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(81, 81, 81)
                                .addComponent(btFileHash)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(btSaveHash))
    ...
    private void btFileHashActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btFileHashActionPerformed
        // TODO add your handling code here:
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Error calcuating hash: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    }//GEN-LAST:event_btFileHashActionPerformed

    private void btSaveHashActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSaveHashActionPerformed
        // TODO add your handling code here:
        JFileChooser fileChooser = new JFileChooser();
        int option = fileChooser.showSaveDialog(this);
        if (option == JFileChooser.APPROVE_OPTION) {
            File file = fileChooser.getSelectedFile();
            String content = txtHash.getText();
    ...
    }//GEN-LAST:event_btSaveHashActionPerformed
    ...
    private javax.swing.JButton btFileHash;
    private javax.swing.JButton btSaveHash;
